...
if __name__ == "__main__":
    ...
    if not args.mp:
        main(list_cercare_maps, list_patients)
    else:
        main_mp(list_cercare_maps, list_patients, num_workers)
