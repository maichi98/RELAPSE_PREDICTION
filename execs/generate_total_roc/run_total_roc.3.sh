...
LABEL_GROUPS=(
    "L3R L3R_5x5x5 L2 L2_5x5x5 L3R - (L1 + L3) L3R - (L1 + L3)_5x5x5 L5 L5_5x5x5"
    "L3 L3_5x5x5 L3 + L3R L3 + L3R_5x5x5 L1 L1_5x5x5 L4 L4_5x5x5"
)

# Loop through each combination of voxel strategies, patient strategies, and label groups
for voxel_strategy in "${VOXEL_STRATEGIES[@]}"; do
    for patient_strategy in "${PATIENT_STRATEGIES[@]}"; do
        for label_group in "${LABEL_GROUPS[@]}"; do
